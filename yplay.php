...
<iframe id="video" allowFullScreen=ture src="<?php echo $qz1;?>" style="width:100%;border:none"></iframe>
<?php
}
?>	
...
<div id="xlu">
<button onclick="xldata('dplayer/index.php?url=')">线路一</button>
<button onclick="xldata('<?php echo $aik["jiekou1"];?>')">线路二</button>
...
$art = file_get_contents('http://www.yy.com/shenqu/show/info.do?resid='.$_GET['post']. '');
$xx = '#"resurl":"(.*?)"#';
...
{
?>
<a href="<?php echo $zlzl;?>">点击这里,可下载该视频！</a>
