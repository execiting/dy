...
<iframe id="video" allowFullScreen=ture src="<?php echo $aik["jiekou1"];?><?php if ($url_array[1] == "m") {echo "$c[0]";}else if ($url_array[1] == "va"){echo "$zyvi[1]";}else{echo "$b[0]";}?>" style="width:100%;border:none"></iframe>
