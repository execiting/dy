...
if(empty($_GET['m'])){$html='https://www.360kan.com/dongman/list?rank=rankhot&cat=all&area=all&year=all&pageno=1';
}else{ 
$html='https://www.360kan.com/dongman/'.$_GET['m'].'&pageno='.$page;
}
?>
<!DOCTYPE HTML>
<html>
...
<a href='dongman.php?m=list.php?cat=all&pageno=1' target='_self'>全部</a>
<?php
...
$response = str_replace('https://www.360kan.com/dongman/list?year=all&area=all&cat=','dongman.php?m=list.php?cat=',$response);
echo $response;
?>
</dd>
</dl>
...
$rurl = str_replace('https://www.360kan.com/dongman/',"dongman.php?m=",$rurl);
echo $rurl;
?> </div>
</div> 
</div></div>
