...
<?php  include 'header.php';?><div class="single-post">
...
echo "<a href='$link1' target='ajax'>";echo "$jiji</a>";}}
?></ul></div>
</div>          
</div>
 </div>
<div style="clear: both;"></div>
<h3 class="single-strong">资源搜索</h3> 
<a  href="seacher.php?sousuo=<?php echo $timu; ?>" class="am-btn am-btn-default lipbtn">点击查看</a>
